<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<?= $title; ?>
			<small>Manajemen Pengaturan Website</small>
		</h1>
	</section>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php foreach($pengaturan as $p){ ?>
							...
							<form method="post" action="<?php echo base_url('dashboard/edit_pengaturan') ?>" enctype="multipart/form-data">
								<div class="box-body">
					                ...
					                <div class="col-sm-5">
					                <img src="<?= base_url('./gambar/website/') . $p['logo'] ; ?>" class="img-thumbnail">
					                </div>
					                <div class="col-sm-9">
					                <br/>
